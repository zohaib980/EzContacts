...
export class MensEyeglassesCatalog
{
    ...
    {
        const randomNumber  = reuseableCode.getRandomNumber(0,13) //Generate a random number 0-13
    ...
    applyReviewFilter()
    {
        const randomNumber  = reuseableCode.getRandomNumber(0,4) //Generate a random number 1-4
